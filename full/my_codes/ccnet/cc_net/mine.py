...
# Local scripts
from ccnet.cc_net import dedup, execution, jsonql, minify, perplexity, process_wet_file
from ccnet.cc_net import regroup as regroup_module
from ccnet.cc_net import split_by_lang
from ccnet.cc_net.execution import Executor
...
REPRODUCE_CONFIG = Config(
    ...
    metadata="https://dl.fbaipublicfiles.com/ccnet.cc_net/1.0.0",
    # Optional filtering:
...
def main(config: str = "base", **config_as_dict: Any) -> None:
    ...
    print(f"Will run ccnet.cc_net.mine.main with the following config:", conf)
