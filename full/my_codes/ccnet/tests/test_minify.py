...
import ccnet.cc_net
import ccnet.cc_net.minify as minify
from ccnet.cc_net import jsonql, process_wet_file
from ccnet.cc_net.minify import (
    HASH_SIZE,
    decode_hashes,
    encode_hashes,
    encode_line_ids,
...
def http_from_disk(monkeypatch):
    ...
    monkeypatch.setattr(ccnet.cc_net.jsonql, "request_get_content", read_sample_file)
