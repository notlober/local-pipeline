...
setup(
    ...
    url="https://github.com/facebookresearch/ccnet.cc_net",
    license="CC-BY-NC-4.0",
    long_description=Path("README.md").read_text(),
    long_description_content_type="text/markdown",
    project_urls={
        "Bug Tracker": "https://github.com/facebookresearch/ccnet.cc_net/issues",
        "Source Code": "https://github.com/facebookresearch/ccnet.cc_net",
    },
    classifiers=[
