...
from redpajama.app.src.core.constants import PRECISION
from redpajama.app.src.core.quality_signals.base import RPSBase
from redpajama.app.src.core.quality_signals.utils.stop_words import get_stop_words
from redpajama.app.src.core.document import Document
from redpajama.app.src.core.data_types import SignalType
from redpajama.app.src.core.quality_signals.utils.content import \
    load_bad_words, load_bad_urls_index
from redpajama.app.src.utilities.register.registry_utils import *
from redpajama.app.src.utilities.text import form_ngrams
...
class RPS_Doc_UT1_Blacklist(RPSBase):  # noqa
    ...
    def __call__(self, document: Document) -> SignalType:
        score: int = self._ut1_mapping.get(document.domain, -1)  # Default to -1 if not found
        return [(0, len(document), score)]
